...
\score {
	...
	\new Staff {
		...
		% \tuplet 3/2 { <e gis dis'>4 <e gis dis'>4 <e gis dis'>4 } \tuplet 3/1 { e4 gis4 dis'4 } r4
	...
	\new DrumStaff {
		% \repeat unfold 6 { \drummode { hh2 hh2 } }
		% \repeat unfold 8 {
			...
			\alternative {
				\drummode { hh4 \tuplet 3/1 { sna4 hh4 hh4 } }
			}
			% <<
			\repeat unfold 4 {
				\drummode { \tuplet 3/1 { sna4 hh4 hh4 } hh4 hh4 hh4 }
			}


			\drummode { \tuplet 3/1 { sna4 hh4 hh4 } hh4 hh4 hh4 }
			\drummode { hh4 \tuplet 3/1 { sna4 hh4 hh4 } hh4 hh4 }
			\drummode { hh4 hh4 \tuplet 3/1 { sna4 hh4 hh4 } hh4 }
			\drummode { hh4 hh4 hh4 \tuplet 3/1 { sna4 hh4 hh4 } }

			% \drummode { bd2 }
			% >>

			% \drummode { bd4 hh4 \tuplet 3/1 { sna4 hh4 hh4 } hho4 }
		...
		% 	% \drummode { \tuplet 3/2 { hh hh sna } r hh }
		% 	\drummode { r \tuplet 3/2 { hh sna hh } sna }
